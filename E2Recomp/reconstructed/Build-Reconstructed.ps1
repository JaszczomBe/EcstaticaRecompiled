...
cmd /c "call `"$VcVars32`" >nul && link /nologo /SUBSYSTEM:WINDOWS /ENTRY:entry /OUT:`"$root\E2Recomp_rebuilt.exe`" `"$root\E2Recomp_recon.obj`" `"$root\E2Recomp_globals.obj`" `"$root\E2Recomp_stubs.obj`" user32.lib gdi32.lib kernel32.lib winmm.lib comdlg32.lib dsound.lib ddraw.lib msacm32.lib"
